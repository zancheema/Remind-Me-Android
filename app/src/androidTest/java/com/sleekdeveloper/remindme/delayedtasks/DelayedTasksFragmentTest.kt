...
class DelayedTasksFragmentTest {
    @ExperimentalCoroutinesApi
    @Test
    fun tasksListDisplaysDelayedTasks() {
        ...
        launchFragmentInContainer<DelayedTasksFragment>(Bundle(), R.style.Theme_RemindMe)
        ...
        onView(withId(R.id.tasksList))
            .check(matches(hasDescendant(withText(task3.title))))
        onView(withId(R.id.tasksList))
